...
export default function Aplicacao() {
    return (
        ...
        // justify-items-start, justify-items-stretch, justify-items-end, justify-items-center
        // content-start, content-end, content-center, content-evenly, 
        // items-start, items-end, items-center
        <div className="border-4 p-3 h-screen grid gap-2 grid-cols-4 content-evenly items-baseline">
